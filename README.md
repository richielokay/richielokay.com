...
You can navigate to the page by visiting ```http://localhost:8080``` in your browser. Begin editing files under the ```app``` folder. All file changes will trigger Livereload to refresh your browser.
